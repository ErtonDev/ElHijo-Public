    ...
    if ctx.author.id == 123 or ctx.author.id == 456:
        ...
        # .admin limpia
            ...
            try:
                ...
                await ctx.send(embed = embedDato(ctx, "x", f"La ficha de {person} está limpia."))
...
async def mod(ctx, path = "None", func = "None", arg1 = "None", user : discord.User = "None"):
    ...
    # ban
        ...
        if user == "None" or user == ctx.message.author:
            ...
            await ctx.send(embed = embedDato(ctx, "Indica a alguien válido para bannear.", "No te pongas a ti ni dejes el espacio en blanco.", "gold"))
